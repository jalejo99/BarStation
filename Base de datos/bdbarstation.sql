...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2022 a las 16:21:03
...
INSERT INTO `comandas` (`idComandas`, `cedulaCociUsu`, `cedulaCamaUsu`, `comentario`, `idEstado`, `idMesa`) VALUES
(1, NULL, 1035669887, '', 1, 2),
(2, NULL, 1035669887, '', 1, 3),
(3, NULL, 1035669887, '', 1, 3),
(4, 1035878342, 1035669887, '', 2, 2),
(5, NULL, 1035669887, '', 1, 2),
(6, NULL, 1035669887, '', 1, 2),
(7, NULL, 1035669887, '', 1, 1),
(8, NULL, 1035669887, '', 1, 3),
(9, NULL, 1035669887, '', 1, 3),
(10, NULL, 1035669887, '', 1, 1),
(11, NULL, 55500033, 'asdfff', 1, 1),
(12, NULL, 55500033, 'asdfff', 1, 2),
(13, NULL, 55500033, '', 1, 1);
...
(12333, 'Punta de anca pequeña', 18000, 1);
...
(55500033, 'Camilo', 'Bustamante', 'Camilo123@gmail.com', '2898423', 'Camilo123', 4, 1),
(102555442, 'Andres', 'Lizcano', 'Andres123@gmail.com', '2022254', 'Andres123', 4, 1),
(1035665985, 'Jaime', 'Jimenes', 'JJ123@gmail.com', '2898455', 'JJ123', 2, 1),
...
--
ALTER TABLE `comandas`
  MODIFY `idComandas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
